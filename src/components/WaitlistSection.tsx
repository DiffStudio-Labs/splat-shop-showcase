      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto glass-card rounded-2xl p-8 md:p-12">
          <div className="text-center mb-8">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 gradient-text">Join Our Waitlist</h2>
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            <div className="p-4">
              ...
              <p className="text-gray-300">Get priority access to our platform before public release.</p>
            </div>
            <div className="p-4">
              <div className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center text-white mx-auto mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <h3 className="text-xl font-semibold mb-2 text-white">Special Pricing</h3>
              <p className="text-gray-300">Exclusive founding member pricing and benefits for early adopters.</p>
            </div>
            <div className="p-4">
              <div className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center text-white mx-auto mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <h3 className="text-xl font-semibold mb-2 text-white">Product Updates</h3>
              <p className="text-gray-300">Stay informed about our latest features and development progress.</p>
            </div>
          </div>
        </div>
      </div>
